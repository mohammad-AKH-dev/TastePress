...
function ServiceBox(props: ServiceBoxPropsType) {
  ...
  return (
    <div dir='rtl' className={`service-box flex flex-row-reverse items-center min-[820px]:min-w-[300px] max-[640px]:w-full max-[745px]:w-[90%] max-[820px]:w-[67%] w-[50%] bg-gradient-to-r justify-center rounded-[10px] text-right gap-x-[24px]
